...
The 'valueOfXInvestedWithoutDividends' function calculates the dollar value return on investments  given a particular CAGR. It uses the standard time value of future investments formula :
$$FV = I*(1+\frac{r}{n})^{(n*t)}$$
